...
session_start();
	...
	//$query ="INSERT INTO busticketing  VALUES ( '{$reg_id}','{$route_id}','{$bus_condition}','{$num_of_seats}' )";
	/*( reg_id , route_id , bus_condition , num_of_seats)*/
	$query="INSERT INTO `busticketing` (`BID`, `reg_id`, `route_id`, `bus_condition`, `num_of_seats`) VALUES (NULL,'{$reg_id}','{$route_id}','{$bus_condition}','{$num_of_seats}' )";
